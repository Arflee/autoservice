        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <div>
            <p className="mb-5">
              ...
              160 00 Praha 6
              <br />
              <strong>PO - PÁ</strong>: 8:00 - 17:00 hod
            </p>
            <p className="mb-5">
              <strong>E-mail</strong>: objednavky@swi.cz
            </p>
            <p className="mb-10">
              <strong>Tel</strong>: 111 222 333
            </p>
            <p>
              <Link
                href="/reservation"
                className="inline-block px-6 py-3 bg-yellow-500 text-white font-bold rounded hover:bg-yellow-600 transition duration-200"
              >
                Online rezervace
              </Link>
            </p>
